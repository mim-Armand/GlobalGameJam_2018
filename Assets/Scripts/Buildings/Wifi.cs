...
public class Wifi : MonoBehaviour
{
    ...
    public GameObject WifisignalPrefab;
    ...
    void Shoot()
    {
        GameObject WifiGO = (GameObject) Instantiate(WifisignalPrefab, firePoint.position, firePoint.rotation);
        Wifisignal wifisignal = WifiGO.GetComponent<Wifisignal>();

        if(wifisignal != null)
        {
            wifisignal.Seek(target);
        }
    }
